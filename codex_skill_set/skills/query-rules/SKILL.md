...
`.codex/doc-advisor/resources/doc-advisor/docs/query_toc_workflow.md` を Read し、`category = rules` として手順に従う。
...
`.codex/doc-advisor/resources/doc-advisor/docs/query_index_workflow.md` を Read し、`category = rules` として手順に従う。
