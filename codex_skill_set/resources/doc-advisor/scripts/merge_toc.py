...
.codex/state/doc-advisor/toc/{category}/{category}_toc.yaml を生成する。

Usage:
    PYTHONDONTWRITEBYTECODE=1 python3 merge_toc.py --category rules [--mode full|incremental]
    PYTHONDONTWRITEBYTECODE=1 python3 merge_toc.py --category specs [--mode full|incremental]
    PYTHONDONTWRITEBYTECODE=1 python3 merge_toc.py --category rules --delete-only
...
def write_yaml_output(docs, output_path, *, category=None, output_config=None):
    ...
    toc_rel_path = f".codex/state/doc-advisor/toc/{_category}/{toc_name}"
    ...
    lines.append(f"# Auto-generated by Doc Advisor Skill create-{_category}-toc - Do not edit directly")
    lines.append("")
