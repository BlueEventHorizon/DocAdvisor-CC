...
`.claude/doc-advisor/toc/keys/<slug>/toc.yaml` from a `key` and a set of
...
# key specified
Task(subagent_type: doc-advisor:toc-updater, prompt: "key: {key}, entry_file: .claude/doc-advisor/toc/keys/<slug>/.toc_work/a1b2c3d4e5f67890.yaml")
Task(subagent_type: doc-advisor:toc-updater, prompt: "key: {key}, entry_file: .claude/doc-advisor/toc/keys/<slug>/.toc_work/1234567890abcdef.yaml")
... (up to 5)
