...
**Important**: This agent processes only one file. Multiple file processing is managed by the orchestrator (/doc-advisor:create-{category}-toc command) via parallel invocation.
