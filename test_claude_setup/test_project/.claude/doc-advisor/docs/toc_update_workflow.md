...
applicable_when:
  - Running as doc-advisor:toc-updater Agent
...
Task(subagent_type: doc-advisor:toc-updater, prompt: "category: {category}, entry_file: .claude/doc-advisor/toc/{category}/.toc_work/xxx.yaml")
Task(subagent_type: doc-advisor:toc-updater, prompt: "category: {category}, entry_file: .claude/doc-advisor/toc/{category}/.toc_work/yyy.yaml")
...
- Entry remains eligible for automatic retry on next run
