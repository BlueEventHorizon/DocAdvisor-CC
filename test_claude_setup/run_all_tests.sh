...
chmod +x "$SCRIPT_DIR/../test_codex/"*.sh 2>/dev/null || true
...
run_test "Phase 2f: version migration" "test_migration.sh"
...
# Phase 7: Codex environment Skills (in ../test_codex/)
CODEX_DIR="$SCRIPT_DIR/../test_codex"
run_test "Phase 7a: Codex Skill Set" "../test_codex/test_codex_skill_set.sh"
run_test "Phase 7b: Codex Setup" "../test_codex/test_setup_for_codex.sh"
run_test "Phase 7c: Codex Scenario" "../test_codex/test_codex_scenario.sh"
